 ...
 * Copyright (C) 2018, Tusko Trush - tusko@photoinside.me
 *
    ...
    function wpa_acf_copier_admin_js() {
        echo "<script type=\"text/javascript\">
            function wpa_acf_editor__create_input(val){
                return '<input class=\"regular-text\" type=\"text\" readonly value=\"'+val+'\" onclick=\"this.select();document.execCommand(\'copy\')\" style=\"width: 100%\" />';
            }
